Ce projet s'inspire du jeu snake il a pour but de le reproduire avec un maximum de ressemblance, donc un serpent qui quand il mange grandit. Tout cela sur pygame.
def :
__init__(self).
